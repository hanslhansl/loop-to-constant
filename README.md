...
The example provided under [A real world example](#a-real-world-example) is an extreme case: The transformed code has 6000 lines whereas the original code has only 12.
